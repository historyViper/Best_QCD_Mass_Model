...
# GOE plain torus projects as cos^2(30 deg), GUE Möbius projects as cos^2(24 deg)
# Correction = cos^2(24 deg)/cos^2(30 deg) = exact ratio between the two grids
...
def print_summary(rows):
    ...
    print(f"    lam_s0   = LU x cos^2(24 deg)/cos^2(30 deg) = {LAM_S0:.6f}              [DERIVED v7.7]")
    print(f"             (GOE plain torus projects as cos^2(30 deg), GUE Möbius as cos^2(24 deg))")
    ...
    print(f"    v9.9: MAPE={mape(rows):.4f}%  RMSE={rmse(obs):.2f} MeV  Sigma0 whitelist removed - WHITELIST NOW EMPTY (0 patches)")
