...
*Established in: gbp_su3_identification.md (Richardson 2026)*

The Z₃₀* lattice is a valid geometric discretization of SU(3).
Eight structural identifications are verified with zero free parameters:

| Check | Property | Result |
|-------|----------|--------|
| 1 | Q₈ = 7/2 (Noether charge) | Exact |
| 2 | C_F = 4/3 (Casimir fundamental) | 0.000% error |
| 3 | Z3 center via color channel groups | Exact |
| 4 | φ(30) = 8 = N²−1 (generator count) | Exact |
| 5 | Coupling hierarchy: asym.free → confine | Structural |
| 6 | Mirror symmetry P(r) = P(30−r) | Exact |
| 7 | 2/3 baryon coupling (combinatorial) | Exact |
| 8 | Flavor sector separation | Structural |

The CKM mixing matrix lies outside the reach of projection weights
alone — it requires a rotation in flavor space, not a projection
amplitude. This is the correct structural boundary of Z₃₀* and is
identified as the next open problem.
...
11. Richardson, J. (2026). Z₃₀* as a Geometric Discretization of SU(3):
    Eight Structural Identifications and One Natural Boundary.
    gbp_su3_identification.md, this repository.
