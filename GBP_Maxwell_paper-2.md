...
**(Correction from earlier draft):** The charge-carrying toroid is T1 (Möbius, 720° spinor closure, spin-1/2), not T0 (plain torus, 360° closure, spin-1). T0 is the photon topology. The electron is T1.
