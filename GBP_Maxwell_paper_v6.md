...
Preprint — May 2026 — **v6.0**  
v6.0 changes: T4 row corrected — gluons are T3 interior Y Hamiltonian paths, NOT T4 (T4 = pentaquarks + entanglement only). Baryon count updated to 55, MAPE updated to 0.2427% (v9.9, zero patches). Lepton unification note: leptons now on C_30 ladder with quarks (MAPE 0.0036%), superseding Koide/C_12 description.  
...
| T4 | Two mod-15 + ER bridge | 1440° | GUE⁴ | Pentaquarks, entanglement |
...
| Hadronic (mod-30) | T1 Möbius winding boundary | P(r) = sin²(rπ/15) | 55 baryons, 0.2427% |
