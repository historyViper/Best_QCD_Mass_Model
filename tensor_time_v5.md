...
*v5 change: Electron revised to mod-12 U(1) self-interference model*
...
### 2.5a The Photon's Properties from T0 (plain torus, mod-30)
...
**The charm special case:**
Charm (r=23) has winding = 720° × 23/30 = 552° = 360° + 192° = 360° + 180° + 12°.
The 12° excess past the half-turn means each T2 traversal by a charm quark
leaves a 12° phase mismatch — exactly half the T1 Hamiltonian beat (24°).
This accumulates: n traversals → n×12° apparent phase offset.
...
transitions. The double helix geometry (two oval strands offset by
H_beat/2 = 20°) explains why charm specifically lands at +12° — it is the
only heavy quark whose T2 winding places it within one natural step (12°)
of the helicity flip boundary.

**The figure-8 as a double helix approximation:**
The HE21 mode formally has two polarization eigenstates — HE21-even and
HE21-odd — separated by 90°. A massive quark couples to both simultaneously,
producing a double helix: two oval strands wound around the tic-tac surface,
offset by H_beat/2 = 20°. The figure-8 is what the double helix looks like
when projected flat — the two crossing points of the double helix become
the single crossing of the figure-8. The figure-8 is a projection artifact,
not the true T2 path. The true path is always the double helix / oval.
...
The photon is T0 with a Möbius twist, a massless surface-running wave.
