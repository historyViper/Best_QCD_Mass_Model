...
Full derivation of the muon and tau masses from this structure is in progress
(see Open Problems, Section 11).
...
**Testable:** Measure a₀ from rotation curves at z=1–2 with JWST/ELT. Constant
a₀ confirms v3. A₀ ∝ H(z) would confirm v2 but require explanation for why
no rotation curve evolution is observed.
...
The **observer-Noether term** (new in v3.0, previously implicit in GOE/GUE
sheet assignments):
...
**Physical meaning of the observer-Noether term:**
...
|---------|--------|-------|
| Lepton mass hierarchy (μ, τ exact) | Open | Mirror pair + interference formula gives ~correct order; exact derivation pending |
| CKM matrix elements (beyond ρη) | Open | ρη = sin²(π/15) derived; full 4-parameter matrix not yet |
| Graviton as T=c perturbation | Open | Gravity reinterpreted but no distinct testable GR deviation yet |
| Continuum limit rate of convergence | Open | Physical mechanism clear; formal O(a/L) proof incomplete |
| Tau mass from interference cross-term | Open | Mechanism identified; numerical derivation in progress |
| Neutrino masses | Open | Ultra-low mass suggests very high n or different Z-sector; not yet modeled |
| UV completion above Λ_topo = 23.89 MeV | Open | Discrete-to-continuum transition scale identified; formal proof pending |
...
83 optical materials, and 7 derived electroweak parameters.
